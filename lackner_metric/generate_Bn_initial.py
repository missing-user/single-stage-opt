...
def generate_Bn_initial(rotating_ellipse = True, plot=False):
    if rotating_ellipse:
        equil = mhd.Spec("qfb_optimization/rotating_ellipse_fb_low.sp", verbose=True)
    else:
        equil = mhd.Spec("qfb_optimization/nfp2_QA_iota0.4.sp", verbose=True)
    ...
    hybrid_surface = simsopt.geo.SurfaceRZFourier.from_vmec_input("qfb_optimization/fixedb/QIlowres/input.rot_ellipse_000_000159")
    ...
    bdistrib_io.write_netcdf("lackner_metric/wout_nfp2_QA_iota0.4.nc", hybrid_surface, "lackner_metric/wout_nfp2_QA_iota0.4_000_000001.nc")
    bdistrib_io.write_nescin_file("lackner_metric/nescin.msurf", middle_surface)
    bdistrib_io.write_nescin_file("lackner_metric/nescin.osurf", outers_surface)
    ...
    filename = "lackner_metric/regcoil_out.hybrid_tokamak.nc"
